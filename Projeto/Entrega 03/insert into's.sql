...
INSERT INTO Registro_Medico_Possiveis_Doencas (Possiveis_Doencas_, RegistroId)
VALUES
  ('Hipertensão', 1),
  ('Colesterol Alto', 2),
  ('Diabetes', 3),
...
VALUES
  ...
  ('30 minutos', 'Danca', 'Diversão e Fitness', 6, 6, '67890123456'),
...
VALUES
  ('Alergia à aspirina', 'MED001'),
  ('Hipersensibilidade à vitamina C', 'MED002'),
  ('Insuficiencia renal', 'MED003'),
  ('Alergia à losartana', 'MED004'),
...
INSERT INTO Medicacao_Efeitos_Colaterais (Efeitos_Colaterais_, MedicacaoId)
VALUES
  ('Dor de cabeca, nausea', 'MED001'),
  ('Diarreia, cãibras estomacais', 'MED002'),
  ('Tontura, nausea', 'MED003'),
  ('Tosse seca, tontura', 'MED004'),
  ('Dor de estômago, azia', 'MED005'),
  ('Nausea, diarreia', 'MED006'),
  ('Fadiga, depressão', 'MED007'),
